        ...
        <div className="space-y-6 relative">
            ...
            <div className="fixed top-4 right-4 z-50 space-y-2">
                {toasts.map((toast) => (
                    <div
                        key={toast.id}
                        className={`px-4 py-3 rounded-xl shadow-lg flex items-center gap-2 animate-in slide-in-from-right ${toast.type === "success"
                ...
                <div className="grid gap-4">
                    {paymentMethods.map((method) => {
                        ...
                        return (
                            <div
                                key={method.id}
                                className={`bg-white dark:bg-zinc-900 rounded-2xl shadow-lg shadow-zinc-200/50 dark:shadow-black/50 border transition-all duration-200 hover:shadow-xl ${expired
                            ...
                            >
                                ...
                                {(expired || expiringSoon) && (
                                    <div className={`mb-4 p-3 rounded-lg flex items-start gap-2 ${expired
