    ...
    return (
        <div className="rounded-2xl border border-slate-200 sm:border-white/10 bg-white sm:bg-white/5 p-4 space-y-3 text-black sm:text-inherit">
            ...
            <div className="flex justify-between items-center">
                <div className="text-sm font-semibold text-black sm:text-gray-900">
                ...
                <>
                    <div className="flex flex-col sm:flex-row gap-2 mt-2">
                        <input
                            ...
                            className="flex-1 rounded-md border border-gray-200 bg-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/40 text-gray-900"
                            autoComplete="email"
                        />
                        ...
                        <div className="relative flex-1">
                            <input
                                ...
                                className="w-full rounded-md border border-gray-200 bg-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/40 text-gray-900 pr-10"
            ...
            {view === 'reset' && (
                <div className="space-y-3">
                    ...
                    <input
                        ...
                        value={email}
                        onChange={(e) => setEmail(e.target.value)}
                        className="w-full rounded-md border border-gray-200 bg-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/40 text-gray-900"
                    />
                    ...
                    {resetMsg && <p className="text-emerald-500 text-xs">{resetMsg}</p>}
