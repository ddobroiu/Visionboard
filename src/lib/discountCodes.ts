...
export async function createDiscountCode({
    ...
    return discountCode as unknown as DiscountCode;
}
...
export async function validateDiscountCode(
    ...
    if ((discountCode.minOrderValue || 0) > 0 && orderValue < (discountCode.minOrderValue || 0)) {
        return {
            isValid: false,
...
export async function createEmailDiscountCode(
    ...
    switch (emailType) {
        ...
        case 'post_purchase':
            ...
            break;
        default:
            // Default callback for typescript completeness
            codeConfig = {
                type: 'percentage',
                value: 0,
                minOrderValue: 0,
