...
<body>
  <div class="container">
    <div class="header">
       <a href="${APP_URL}" style="text-decoration:none; color: white; font-size: 24px; font-weight: bold;">
         Visionboard
       </a>
    </div>
    <div class="content">
    ...
    <div class="footer">
      © ${new Date().getFullYear()} Visionboard. Toate drepturile rezervate.<br/>
...
export async function sendOrderConfirmationEmail(order: any) {
    ...
    <div style="background-color: #f0f9ff; border: 1px solid #bae6fd; border-radius: 8px; padding: 16px; margin: 24px 0;">
      ...
      <p style="font-size: 13px; margin-top: 12px; color: #0369a1; border-top: 1px solid #bae6fd; padding-top: 8px;">
        <strong>Important:</strong> Pentru o procesare rapidă, te rugăm să trimiți dovada plății (OP-ul) pe email la adresa <a href="mailto:contact@visionboard.ro" style="color: #0369a1; text-decoration: underline;">contact@visionboard.ro</a>.
      </p>
    </div>
  ` : '';
